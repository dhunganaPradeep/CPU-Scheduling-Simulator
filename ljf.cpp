...
// opposite of SJF basically
// pick the longest burst time first and run it fully
// not the best for avg waiting time but whatever its an algorithm
...
void ljf(int proc[],int bt[],int n)
{
    ...
    // bubble sort by burst time DESCENDING (longest first)
    for(int i=0;i<n-1;i++){
